...
class Category(models.Model):
    ...
    slug = models.SlugField(max_length=55, unique=True, db_index=True, verbose_name="Category Slug")
...
class Product(models.Model):
    ...
    slug = models.SlugField(max_length=160, unique=True, db_index=True, verbose_name="Product Slug")
